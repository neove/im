...
var myTeam = {
	...
	showUserList: function(type,teamType) {
		...
		this.$createTeamContainer.load('http://10.189.1.99:8888/webdemo/im/create-team.html', function() {
	...
	showTeamInfo: function(o) {
		var $this = $(o),
	 		that = this;
		this.$teamInfoContainer.load('http://10.189.1.99:8888/webdemo/im/team-info.html', function() { 
			// 获取群成员
			...
			if(type==="advanced"){
				...
				var avatarUrl = teamInfo.avatar ? (teamInfo.avatar+"?imageView&thumbnail=40y40") : "http://10.189.1.99:8888/webdemo/im/images/advanced.png";
				...
				$teamName.addClass('owner');
				$teamDesc.addClass('owner');
				$teamAvatar[0].src = "http://10.189.1.99:8888/webdemo/im/images/normal.png";
			}
