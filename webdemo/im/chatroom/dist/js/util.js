var util ={
    ...
    getAvatar:function(url) {
        ...
        if(re.test(url)){
            ...
            return "http://10.189.1.99:8888/webdemo/im/images/default-icon.png"
        } 
    },
        ...
        switch (data.type){
            ...
            case 'custom':
                if (!data.content) {
                    ...
                    if(content.type===1){
                        text = '<img src="http://10.189.1.99:8888/webdemo/im/images/play-'+content.data.value+'.png" onload="page.scrollToBottom()">';
                    }   
                }
                break;
            default:
